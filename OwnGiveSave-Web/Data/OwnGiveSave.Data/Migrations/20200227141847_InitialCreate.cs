        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBloodPositive = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeOfTheHospital = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(nullable: false),
                    DeletedOn = table.Column<DateTime>(nullable: true),
                    OwnGiveSaveUserId = table.Column<string>(nullable: false),
                    BloodId = table.Column<string>(nullable: false),
                    LastBloodDonation = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Donors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Donors_Blood_BloodId",
                        column: x => x.BloodId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HospitalId = table.Column<string>(nullable: false),
                    BloodId = table.Column<string>(nullable: false),
                    DeadlineOfTheDonations = table.Column<DateTime>(nullable: false),
                    NeededDonators = table.Column<int>(nullable: false),
                    LitersOfBloodPerDonor = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LitersOfDonatedBlood = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DonorHospitals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DonorHospitals_Donors_DonorId",
                        column: x => x.DonorId,
                        principalTable: "Donors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DonorHospitals_Hospitals_HospitalId",
                        column: x => x.HospitalId,
                        principalTable: "Hospitals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DonorHospitals_Patients_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Blood_IsDeleted",
                table: "Blood",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_DonorHospitals_DonorId",
                table: "DonorHospitals",
                column: "DonorId");

            migrationBuilder.CreateIndex(
                name: "IX_DonorHospitals_HospitalId",
                table: "DonorHospitals",
                column: "HospitalId");

            migrationBuilder.CreateIndex(
                name: "IX_DonorHospitals_IsDeleted",
                table: "DonorHospitals",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_DonorHospitals_PatientId",
                table: "DonorHospitals",
                column: "PatientId");
