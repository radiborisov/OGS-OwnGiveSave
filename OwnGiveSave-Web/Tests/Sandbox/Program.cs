namespace Sandbox
{
    ...
    public static class Program
    {
        ...
        private static void ConfigureServices(ServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<OwnGiveSaveUser>(IdentityOptionsProvider.GetIdentityOptions)
                .AddRoles<OwnGiveSaveRole>().AddEntityFrameworkStores<OwnGiveSaveDbContext>();
